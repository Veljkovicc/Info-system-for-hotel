...
namespace veljkonrt8020
{
    public partial class forma1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                if (korisnik1.Vrstakorisnika.ToLower() == "admin")
                {
                    if (korisnik1.Korisnickoime.ToLower() == txtKorisnickoImeAdmin.Text && korisnik1.Lozinka == txtLozinkaAdmin.Text)
                    {
                        FormaAdmin1 adminforma = new FormaAdmin1();
                        adminforma.Show();
                        this.Hide();
                        fs1.Close();
                        flag = 1;
